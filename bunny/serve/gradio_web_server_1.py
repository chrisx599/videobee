...
def save_conversation(conversation):
    ...
    pypandoc.convert_text(html_content, 'docx', format='html', outputfile=doc_path,extra_args=["-M2GB", "+RTS", "-K64m", "-RTS"])
    return doc_path
...
[📖[Technical report](https://arxiv.org/abs/2402.11530)] | [🏠[Code](https://github.com/BAAI-DCAI/Bunny)] | [🤗[Model](https://huggingface.co/BAAI/bunny-phi-2-siglip)]
...
def build_demo(embed_mode):
    ...
    with gr.Blocks(title="Bunny", theme=gr.themes.Default(primary_hue="blue", secondary_hue="lime"), css=block_css) as demo:
        state = gr.State()
