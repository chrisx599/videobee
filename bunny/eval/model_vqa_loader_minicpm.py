...
from bunny.util.mm_utils import tokenizer_image_token, process_images, get_model_name_from_path,KeywordsStoppingCriteria
...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        content_ids = minicpm_tokenizer_image_token(qs, self.tokenizer)
