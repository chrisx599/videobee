...
class SigLipVideoProcessor:
    def __init__(self,
        ...
        GroupScale(int(384), interpolation=InterpolationMode.BICUBIC),
        GroupCenterCrop(384),
        Stack(),
        ToTorchFormatTensor(),
    ...
    def preprocess(self, images, return_tensors):
        ...
        # return BatchFeature(data=data, tensor_type=return_tensors)
        transformed_images  = rearrange(transformed_images, '(t c) h w-> c t h w',c=3)
...
class SigLipVisionTower(nn.Module):
    def __init__(self, vision_tower, vision_tower_cfg, delay_load=False):
        ...
        self.video_processor = SigLipVideoProcessor()
