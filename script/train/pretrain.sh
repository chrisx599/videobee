...
deepspeed bunny/train/train.py \
    ...
    --model_name_or_path /zhaobai46d/Qwen1.5-1.8B \
    --model_type $MODEL_TYPE \
    --version plain \
    --data_path /zhaobai46d/share/bunny/data/laion-pretrain/pretrain_data_laion_2m.json \
    --image_folder /zhaobai46d/share/bunny/data/laion-pretrain/images \
    --vision_tower /zhaobai46d/siglip-so400m-patch14-384 \
